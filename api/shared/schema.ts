...
export const insertQuranSurahSchema = createInsertSchema(quranSurahs).omit({ id: true });
export const insertReciterSchema = createInsertSchema(reciters).omit({ id: true });
export const insertBukhariHadithSchema = createInsertSchema(bukhariHadiths).omit({ id: true });
export const insertMuslimHadithSchema = createInsertSchema(muslimHadiths).omit({ id: true });
export const insertVerificationHadithSchema = createInsertSchema(verificationHadiths).omit({ id: true });
