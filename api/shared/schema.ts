...
export const insertQuranSurahSchema = createInsertSchema(quranSurahs);
export const insertReciterSchema = createInsertSchema(reciters);
export const insertBukhariHadithSchema = createInsertSchema(bukhariHadiths);
export const insertMuslimHadithSchema = createInsertSchema(muslimHadiths);
export const insertVerificationHadithSchema = createInsertSchema(verificationHadiths);
...
export type DailyWard = typeof dailyWard.$inferSelect;
export type SiteStats = typeof siteStats.$inferSelect;
export type BukhariHadith = typeof bukhariHadiths.$inferSelect;
export type MuslimHadith = typeof muslimHadiths.$inferSelect;
export type VerificationHadith = typeof verificationHadiths.$inferSelect;
