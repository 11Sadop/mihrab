                        ...
                        >
                            <div className="p-4 space-y-3">
                                ...
                                <div className="flex items-start justify-between gap-2">
                                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-medium ${getGradeBadgeColor(result.grade)}`}>
                                        {(result.grade.includes("صحيح") || result.grade.includes("حسن") || result.grade.includes("رجال")) && <CheckCircle2 className="w-3 h-3" />}
                                        {result.grade}
                                    </span>
                                </div>
