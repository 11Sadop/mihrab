...
const RECITERS:Rec[]=[
  ...
  {id:"shuraym", name:"سعود الشريم",        server:"https://server7.mp3quran.net/shur",           ev:"Saood_ash-Shuraym_128kbps"},
  ...
  {id:"juhany",  name:"عبدالله الجهني",     server:"https://server11.mp3quran.net/jhn",           ev:"Abdullaah_3awwaad_Al-Juhaynee_128kbps"},
