...
export default function Home() {
  ...
  return (
    <main className="container max-w-md sm:max-w-xl md:max-w-3xl lg:max-w-4xl mx-auto px-4 sm:px-6 md:px-8 pb-32 space-y-5 pt-12 sm:pt-14">
      ...
      {/* 3. Large Gradient Cards (Adhkar & Duas) - Adhkar LEFT, Duas RIGHT */}
      <section className="grid grid-cols-2 gap-3">
        {/* Adhkar - Orange/Amber (LEFT = FIRST in DOM) */}
        <Link href="/adhkar">
          <div className="relative overflow-hidden h-32 rounded-2xl bg-gradient-to-br from-orange-400 via-orange-500 to-amber-500 p-4 flex flex-col items-center justify-center text-center shadow-lg shadow-orange-900/20 cursor-pointer hover:scale-[1.02] transition-transform">
        ...
        {/* Duas - Blue/Purple (RIGHT = SECOND in DOM) */}
        <Link href="/duas">
          <div className="relative overflow-hidden h-32 rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 p-4 flex flex-col items-center justify-center text-center shadow-lg shadow-indigo-900/20 cursor-pointer hover:scale-[1.02] transition-transform">
