...
const tasbeehItems: TasbeehItem[] = [
  ...
  },
  {
    ...
    target: null,
    virtueHadith: "يُغرس لك بكل واحدة شجرة في الجنة. وهي الباقيات الصالحات",
    virtueSource: "صحيح ابن ماجه - صححه الألباني",
    category: "general"
  },
  {
    id: 8,
  ...
  },
  {
    ...
    target: 1,
    virtueHadith: "دعاء أوصى به النبي ﷺ أن يقال عند الكرب والشدة",
    virtueSource: "صحيح الترغيب - حسنه الألباني",
    category: "general"
  },
  {
    id: 19,
    ...
    target: 3,
    virtueHadith: "كان النبي ﷺ يقول هذا الدعاء ثلاث مرات حين يصبح وحين يمسي",
    virtueSource: "سنن أبي داود - حسنه الألباني",
    category: "general"
  },
  {
    id: 20,
    ...
    target: 1,
    virtueHadith: "دعاء كان النبي ﷺ يستعيذ به من ثمانية أشياء",
    virtueSource: "صحيح البخاري",
    category: "general"
  },
  {
    ...
    target: 1,
    virtueHadith: "من قالها موقناً بها حين يمسي فمات من ليلته دخل الجنة",
    virtueSource: "صحيح البخاري",
    category: "general"
  },
  {
    ...
    target: 100,
    virtueHadith: "كان النبي يقولها في المجلس الواحد مائة مرة",
    virtueSource: "سنن أبي داود",
    category: "general"
  },
  {
    ...
    target: 1,
    virtueHadith: "لا تدعن في دبر كل صلاة أن تقول هذا الدعاء",
    virtueSource: "سنن أبي داود",
    category: "post_prayer"
  },
  {
  ...
  },
  {
    ...
    target: 7,
    virtueHadith: "من قالها سبع مرات بعد صلاة الصبح والمغرب أجاره الله من النار",
    virtueSource: "سنن أبي داود",
    category: "post_prayer"
  },
  {
    ...
    target: 1,
    virtueHadith: "كان النبي يقولها بعد صلاة الفجر",
    virtueSource: "صحيح مسلم",
    category: "post_prayer"
  },
  {
    id: 29,
    text: "اللَّهُمَّ اغْفِرْ لِي وَارْحَمْنِي وَاهْدِنِي وَارْزُقْنِي وَعَافِنِي",
    target: 1,
    virtueHadith: "هؤلاء الكلمات تجمع لك أمر دينك ودنياك",
    virtueSource: "صحيح مسلم",
    category: "general"
  },
];
