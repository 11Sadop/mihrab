...
export const api = {
  ...
  stats: {
    ...
    pageStats: {
      method: 'GET' as const,
      path: '/api/stats/page-stats',
      responses: {
        200: z.object({
          totalVisits: z.number(),
          todayVisits: z.number(),
          pages: z.array(z.object({ page: z.string(), count: z.number() })),
          last7Days: z.array(z.object({ date: z.string(), count: z.number() })),
        }),
      },
    },
  },
