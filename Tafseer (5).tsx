              ...
              {groups.map((g,gi)=>{
                return <div key={`${g.sn}-${gi}`} className="relative w-full">
                  ...
                  {g.ayahs[0].nis===1&&g.sn!==9&&<div className="text-center mt-2 mb-8" dir="rtl">
                      ...
                      {g.sn===1 && (
                        <span className="font-quran select-none"
                          style={{color:(playingKey===`${g.sn}-1`&&g.sn===1)?'#16a34a':'#c8a96e',fontSize:'0.72em',verticalAlign:'middle',margin:'0 0.15em'}}>
                          {`\u06DD١`}
                        </span>
                      )}
                    </span>
                    ...
                    {g.ayahs.map(a=>{
                      ...
                      if(cur){
                         ...
                         return <span key={k} className="inline" data-v="1" id={`verse-${g.sn}-${a.nis}`} 
                            ...
                            <span className="font-quran select-none"
                              style={{color:'#c8a96e',fontSize:'0.72em',verticalAlign:'middle',margin:'0 0.15em'}}>
                              {`\u06DD؟`}
                            </span>
                         </span>;
                      }
                      ...
                      return<span key={k} className="inline" data-v="1" id={`verse-${g.sn}-${a.nis}`}>
                        ...
                        <span
                          className="font-quran select-none"
                          data-v="1"
                          style={{
                            color: isP ? '#16a34a' : bookmarks.has(k) ? '#ec4899' : colors.border,
                            fontSize: '0.72em',
